print ("""
========================plot_best_config_ttds.py========================
Plots DREAM TTD spread per scenario for each configuration
...
if (len(sys.argv) != 2):
	print('Usage : plot_best_config_ttds.py <csv file>\n')
	exit()

# Arguments
csvfile=sys.argv[1]
#csvfile='C:\\Users\\whit162\\OneDrive - PNNL\\Documents\\Projects\\DreamProject\\Results_20191203160351\\best_configuration_ttds.csv'
...
new_folder = os.path.join(os.path.dirname(csvfile) + '/best_config_ttd_plots')
print(new_folder)
