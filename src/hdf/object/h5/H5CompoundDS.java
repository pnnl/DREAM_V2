        ...
        if (did >= 0) {
            ...
            try {
                ...
                for (int i = 0; i < numberOfMembers; i++) {
                    ...
                    memberOrders[i] = 1;
                    memberDims[i] = null;
                    log.trace("init()[{}] memberNames[{}]={}, memberTIDs[{}]={}, memberTypes[{}]={}",
                            i, i, memberNames[i], i, memberTIDs[i], i, memberTypes[i].getDatatypeDescription());
            ...
            try {
                ...
                for (int i = 0; i < n; i++) {
                    ...
                    if (member_data != null) {
                        ...
                        try {
                            log.trace("H5CompoundDS read: H5Dread({}) did={} spaceIDs[0]={} spaceIDs[1]={} isVL={}", comp_tid, did, spaceIDs[0], spaceIDs[1], isVL);
                            if (isVL) {
