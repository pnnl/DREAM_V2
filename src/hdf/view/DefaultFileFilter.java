...
public class DefaultFileFilter extends FileFilter {
     ...
     * 
     * @param extension The extension for this FileFilter to filter by
     * 
     * @see #addExtension
     */
     ...
     * @param extension The extension for this FileFilter to filter by
     * 
     * @param description The human readable description of this FileFilter
     * 
     * @see #addExtension
     */
     ...
     * 
     * @param filters The array of extensions for this FileFilter to filter by
     * 
     * @see #addExtension
     */
     ...
     * 
     * @param f The file to get the extension portion of the name for
     * 
     * @return The extension portion of the given file's name
     * 
     * @see #getExtension
     ...
     * Note that the "." before the extension is not needed and will be ignored.
     * 
     * @param extension The "dot" extension to add
     */
     ...
     * 
     * @param description The human readable description to set for this filter
     */
     ...
     * setDescription();
     * 
     * @param b Sets extension list to show up in the human readable description
     *          if true; list doesn't show up otherwise
     */
     ...
     * 
     * @return A FileFilter for HDF4/5 files
     */
     ...
     * 
     * @return A FileFilter for HDF4 files
     */
     ...
     * 
     * @return A FileFilter for HDF5 files
     */
     ...
     * 
     * @return A FileFilter for JPEG image files
     */
     ...
     * 
     * @return A FileFilter for TIFF image files
     */
     ...
     * 
     * @return A FileFilter for PNG image files
     */
     ...
     * 
     * @return A FileFilter for BMP image files
     */
     ...
     * 
     * @return A FileFilter for GIF image files
     */
     ...
     * 
     * @return A FileFilter for GIF, JPEG, BMP, or PNG image files
     */
     ...
     * 
     * @return A FileFilter for text files
     */
     ...
     * 
     * @return A FileFilter for binary files
     */
     ...
     * 
     * @return true if the specified file is an HDF4 file; false otherwise
     */
     ...
     * @param filename The name of the file to check
     * 
     * @return true if the specified file is an HDF5 file; false otherwise
     */
     ...
     * @param filename The name of the file to check
     * 
     * @return true if the specified file is a NetCDF file; false otherwise
     */
     ...
     * 
     * @param filename The name of the file to read the HDF5 user block from
     * 
     ...
     * 
     * @param fin The name of the file to copy to the output file
     * 
     * @param fout The name of the file to write HDF5 user block data to
     * 
     * @param buf The HDF5 user block data to write into the output file
     * 
     * @return a byte array of user block, or null if there is user data.
     */
