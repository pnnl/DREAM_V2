...
public class DataOptionDialog extends JDialog implements ActionListener, ItemListener
{
     ...
     * 
     * @param theDataset The dataset to set display options for
     */
    ...
    public DataOptionDialog(ViewManager theview, Dataset theDataset) {
        ...
        if (dataset instanceof CompoundDS) {
            ...
            if (isText) {
                ...
                bitmaskButtons = (tsize >= 0) ? new JRadioButton[8 * tsize] : new JRadioButton[0];
     ...
     * 
     * @return true if the data selection is cancelled; false otherwise
     */
     ...
     * 
     * @return true if the display option is image; false otherwise
     */
     ...
     * 
     * @return true if only applying the bitmask; false otherwise
     */
